...
SEARCH_PATHS = [
    'public/index2.html',
    'index2.html',
    os.path.join(os.path.dirname(os.path.abspath(__file__)), 'public', 'index2.html'),
    os.path.join(os.path.dirname(os.path.abspath(__file__)), 'index2.html'),
]
FILE = None
...
if not FILE:
    print('ERROR: index2.html not found')
