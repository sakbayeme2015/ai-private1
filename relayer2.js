//  relayer.js — PrivateBridge Relayer
//  OpenClaw Chain (123456) → Ethereum Mainnet (1) DIRECT
//  Contract: 0xDD7917A79515FeaA5Ce15Fa84E8c74b931Dec990
//  Deployed: 2026-07-14T00:13:22.062Z · Block #571,579
//  ─────────────────────────────────────────────────────────
//  Leg A: ETHLocked on private chain → send ETH on mainnet
//  Leg B: TokensLocked (sUSDC) → send USDT on mainnet
//  No verification · No reserve · No tracking · Direct send
//  P2P: devp2p port 30303 (OpenClaw Chain peering)
//  Dual oracle: CoinGecko + Binance simultaneously
// ============================================================
